...
public struct TemplateAnalysis {
    public struct ParameterStats {
        ...
        public func randomValue(strength: RandomizeStrength, rng: inout RandomNumberGenerator) -> UInt8 {
